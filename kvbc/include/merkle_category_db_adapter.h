...
class DBAdapter : public IDbAdapter {
 public:
  ...
  storage::rocksdb::NativeWriteBatch lastReachableBlockDbUpdates(const SetOfKeyValuePairs &updates,
 ...
 private:
  ...
  concord::kvbc::categorization::detail::MerkleCategory category_;
