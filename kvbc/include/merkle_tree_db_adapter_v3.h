...
class DBAdapter : public IDbAdapter {
 public:
  ...
  const std::shared_ptr<storage::rocksdb::NativeClient> &getNativeClient() const { return rocksdb_; }
 ...
 private:
  ...
  v2MerkleTree::block::detail::Node getBlockNode(BlockId blockId) const;
  ...
  concord::storage::rocksdb::WriteBatch lastReachableBlockKeyDeletes(BlockId blockId) const;

  concord::storage::rocksdb::WriteBatch genesisBlockKeyDeletes(BlockId blockId) const;
  ...
  void deleteKeysForBlock(concord::storage::rocksdb::WriteBatch &&batch, BlockId blockId) const;
  ...
  std::shared_ptr<storage::rocksdb::NativeClient> rocksdb_;
