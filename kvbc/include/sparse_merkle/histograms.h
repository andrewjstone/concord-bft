...
struct Recorders {
  ...
  DEFINE_SHARED_RECORDER(dba_get_raw_block, 1, MAX_NS, 3, Unit::NANOSECONDS);
  DEFINE_SHARED_RECORDER(dba_last_reachable_block_db_updates, 1, MAX_NS * 5, 3, Unit::NANOSECONDS);
  ...
  DEFINE_SHARED_RECORDER(dba_get_leaf_key_val_at_most_version, 1, MAX_NS, 3, Unit::NANOSECONDS);
