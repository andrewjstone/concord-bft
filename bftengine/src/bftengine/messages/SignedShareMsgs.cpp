...
std::unique_ptr<SignedShareBase> SignedShareBase::create(int16_t type,
                                         ViewNum v,
                                         SeqNum s,
                                         ReplicaId senderId,
                                         Digest& digest,
  ...
  std::unique_ptr<SignedShareBase> m(new SignedShareBase(senderId, type, size));
...
bool SignedShareBase::ToActualMsgType(const ReplicasInfo& repInfo,
  ...
  const SignedShareBase* t = (SignedShareBase*)inMsg;
...
std::unique_ptr<PreparePartialMsg> PreparePartialMsg::create(
    ViewNum v,
    SeqNum s,
    ReplicaId senderId,
    Digest& ppDigest,
...
bool PreparePartialMsg::ToActualMsgType(const ReplicasInfo& repInfo,
  ...
  std::unique_ptr<SignedShareBase> pOutMsg; 
...
std::unique_ptr<PrepareFullMsg> PrepareFullMsg::create(
...
std::unique_ptr<CommitPartialMsg> CommitPartialMsg::create(ViewNum v,
                                           SeqNum s,
                                           ReplicaId senderId,
...
std::unique_ptr<CommitFullMsg> CommitFullMsg::create(
